        ...
        <div class="col-12">
            ...
            <div class="d-flex flex-wrap justify-content-between pt-2 pb-4 mb-1">
                ...
                <div class="mt-3">
                    ...
                    <!-- Facebook share -->
                    <a class="btn-social bs-facebook me-2 mb-2"
                        href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(Request::url()) }}&text={{ urlencode($baiviet->tieude) }}"
                        target="_blank">
                        <i class="ci-facebook"></i>
                    </a>
                    <!-- Twitter/X share -->
                    <a class="btn-social bs-twitter me-2 mb-2"
                        href="https://twitter.com/intent/tweet?url={{ urlencode(Request::url()) }}&text={{ urlencode($baiviet->tieude) }}"
                        target="_blank">
                    ...
                    <div class="card border-0 shadow mt-2 mb-4">
                        <div class="card-body">
                            <div class="d-flex align-items-start">
                                <img class="rounded-circle" src="{{ asset('public/img/03.jpg') }}" width="50" />
                                <form class="w-100 needs-validation ms-3" action="{{ route('user.binhluan.them', ['baiviet_id' => $baiviet_id]) }}" method="post" novalidate>
                                    @csrf
                                    <div class="mb-3">
                                        <textarea class="form-control" rows="3" placeholder="Chia sẻ ý kiến của bạn..." name="noidungbinhluan" required></textarea>
                                        @guest
