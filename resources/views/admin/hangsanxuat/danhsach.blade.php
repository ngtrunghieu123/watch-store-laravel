        ...
        <table class="table table-bordered table-hover table-sm mb-0">
            <thead>
                <tr>
                    ...
                    <th width="25%">Tên hãng không dấu</th>
                    <th width="5%">Sửa</th>
                    <th width="5%">Xóa</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <img src="{{ asset('storage/app/private/' . $value->hinhanh) }}" width="100" class="img-thumbnail" />
                    </td>
                    <td>{{$value->tenhang}}</td>
                    ...
                    <td class="text-center">
                        <a href="{{route('admin.hangsanxuat.xoa', ['id' => $value->id])}}"
                            onclick="return confirm('Bạn muốn xóa hãng sản xuất {{$value->tenhang}} không?')">
