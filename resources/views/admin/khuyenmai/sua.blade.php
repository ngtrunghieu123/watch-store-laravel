...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Sửa khuyến mãi</div>
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('admin.khuyenmai.sua', ['id' => $khuyenmai->id]) }}" method="post" enctype="multipart/form-data">
                        @csrf

                        <div class="mb-3">
                            <label class="form-label" for="tenkhuyenmai">Tên khuyến mãi</label>
                            <input type="text" class="form-control @error('tenkhuyenmai') is-invalid @enderror" id="tenkhuyenmai" name="tenkhuyenmai" value="{{ old('tenkhuyenmai', $khuyenmai->tenkhuyenmai) }}" required />
                            @error('tenkhuyenmai')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('mota') is-invalid @enderror" id="mota" name="mota">{{ old('mota', $khuyenmai->mota) }}</textarea>
                            @error('mota')
                            <div class="invalid-feedback"><strong>{{ $message }}</strong></div>
                            @enderror
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('ngaybatdau') is-invalid @enderror" id="ngaybatdau" name="ngaybatdau" value="{{ old('ngaybatdau', date('Y-m-d', strtotime($khuyenmai->ngaybatdau))) }}" required />
                                    @error('ngaybatdau')
                                    <div class="invalid-feedback"><strong>{{ $message }}</strong></div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('ngayketthuc') is-invalid @enderror" id="ngayketthuc" name="ngayketthuc" value="{{ old('ngayketthuc', date('Y-m-d', strtotime($khuyenmai->ngayketthuc))) }}" required />
                                    @error('ngayketthuc')
                                    <div class="invalid-feedback"><strong>{{ $message }}</strong></div>
                                    @enderror
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="number" min="1" max="100" class="form-control @error('phantram') is-invalid @enderror" id="phantram" name="phantram" value="{{ old('phantram', $khuyenmai->phantram) }}" required />
                        ...
                        <div class="mb-3 form-check">
                            <input class="form-check-input" type="checkbox" id="trangthai" name="trangthai" value="1" {{ $khuyenmai->trangthai == 1 ? 'checked' : '' }} />
                                    ...
                                    <div class="col-md-3 mb-2 product-item"
                                        ...
                                        <div class="form-check border p-2 rounded">
                                            <input class="form-check-input product-checkbox" type="checkbox" id="sanpham_{{ $sp->id }}"
                                                ...
                                                {{ in_array($sp->id, $khuyenmai->sanPham->pluck('id')->toArray()) ? 'checked' : '' }} />
